...
if __name__ == '__main__':
    ...
    f = open("./DY_Dataset/large-wiki/enwiki20_edges.json", 'r')
    ...
    with open("./DY_Dataset/large-wiki/config.txt", 'w') as f:
        max_dict_keys_list = sorted(year_dict.keys())
        config_str = "./DY_Dataset/Target/large-wiki.txt\n"

        for i in range(len(max_dict_keys_list)):
            config_str += "./DY_Dataset/large-wiki/" + str(max_dict_keys_list[i]) + ".txt" + "\n"
