...
int main(int argc,  char **argv){
  ...
  // This "config_LP.txt" is the file for 
  ...
  for(int iter = 1; iter < snapshots_number; iter++){
    ...
    //Inside this function we output the training data
    ...
    for(int i = 0; i < m2; i++){
      ...
      std::unordered_set<int>::iterator find_iter = subset_nodes_set.find(from);
      if(find_iter != subset_nodes_set.end())
      {
